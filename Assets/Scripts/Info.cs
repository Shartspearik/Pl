    ...
    private void OnHoverEnter()
    {
        ...
        break;
            ...
            case 16:
                ...
                panel.transform.GetChild(3).GetChild(1).gameObject.SetActive(true);
                panel.transform.GetChild(3).GetChild(1).GetChild(0).GetComponent<TextMeshProUGUI>().text = 111 + "47,3с";
                panel.transform.GetChild(3).GetChild(1).GetChild(1).GetComponent<Image>().sprite = iconeOre[0];
        ...
        break;
            ...
            case 17:
                ...
                panel.transform.GetChild(3).GetChild(1).gameObject.SetActive(true);
                panel.transform.GetChild(3).GetChild(1).GetChild(0).GetComponent<TextMeshProUGUI>().text = 113 + "47,3с";
                panel.transform.GetChild(3).GetChild(1).GetChild(1).GetComponent<Image>().sprite = iconeOre[0];
